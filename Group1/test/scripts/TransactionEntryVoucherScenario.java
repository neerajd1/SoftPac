...
public class TransactionEntryVoucherScenario {
	...
	public Object[][] createData1() throws IOException {
		Object[][] retObjArr = getExcelData(
				"test2\\resources\\data\\Transaction.xlsx","SingleAccount");// for xlsx
	...
	public void  setUp(){
		...
		/*pom1=new LoginPOM(driver, "chrome");
		driver=pom1.setChrome();*/
	...
	public void viewPhotoSignature(String memberID ,String accountNumber,String transactionType,String instrumentType,String transactionCode,String amount){
